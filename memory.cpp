...
void *realloc(void *ptr, unsigned int size)
{
    ...
    if (ptr == (void*)&memf || ptr == (void*)&memb)
    {
        ...
        void *pf = (void*)&memf;
        void *pb = (void*)&memb;
        unsigned int newSize = memf.max_size() + 100;
    ...
    if (oldSize > size)
    {
        ...
        //*(char *)0xB8056 = 'r';
        //*(char*)0xB8057 = 0x0D;
        memcpy(pointer, ptr, size);            //not working right for no discernable reason. might as well use slower but easier to debug versions of functions when possible
    }
    else if (oldSize == 0)
    {
        pointer = alloca(1, size);
    ...
    else
    {
        ...
        //*(char *)0xB8056 = 'r';
        //*(char*)0xB8057 = 0x0D;
        memcpy(pointer, ptr, oldSize);         //not working right for no discernable reason. might as well use slower but easier to debug versions of functions when possible
