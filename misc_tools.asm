...
global TGSS_waitNotFull
TGSS_waitNotFull:
    mov dx, 0x426
    in al, dx           ;it works a lot better if you actually remmeber to read the port
    and al, 00110000b   ;if the almost full bit is not zero, wait until its zero
    cmp al, 0           
    jne TGSS_waitNotFull
ret
...
setupPS2Controller:
    ...
    call kbd8042WaitWriteReady
    mov al, 00100100b
    out 0x64, al       ;configuration byte
    ...
    call kbd8042WaitWriteReady
    mov al, 0xAB
    out 0x64, al        ;the self-test command
...
top_idt:
    ...
    %include "drivers/v9958driver.asm"
