...
void graphicsModeDrawText_tgss(unsigned int posX, unsigned int posY, short letter, unsigned short color, unsigned short backgroundColor, bool transparentBackground)
{
